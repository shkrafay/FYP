...
<!--                                 style="background-image:url(images/xteacher-1.jpg.pagespeed.ic.AyWvtajk8X.jpg)">-->
<!--                            </div>-->
...
<!--                        <div class="testimony-wrap d-flex">-->
<!--                            <div class="user-img mr-4"-->
<!--                                 style="background-image:url(images/xteacher-2.jpg.pagespeed.ic.RFUpMj6Lab.jpg)">-->
<!--                            </div>-->
<!--                            <div class="text ml-2 bg-light">-->
<!--<span class="quote d-flex align-items-center justify-content-center">-->
<!--<i class="icon-quote-left"></i>-->
...
<!--                        <div class="testimony-wrap d-flex">-->
<!--                            <div class="user-img mr-4"-->
<!--                                 style="background-image:url(images/xteacher-3.jpg.pagespeed.ic.po_-LXQR-Y.jpg)">-->
<!--                            </div>-->
<!--                            <div class="text ml-2 bg-light">-->
<!--<span class="quote d-flex align-items-center justify-content-center">-->
<!--<i class="icon-quote-left"></i>-->
...
<!--                        <div class="testimony-wrap d-flex">-->
<!--                            <div class="user-img mr-4"-->
<!--                                 style="background-image:url(images/xteacher-4.jpg.pagespeed.ic.lo-cdHm6M8.jpg)">-->
<!--                            </div>-->
<!--                            <div class="text ml-2 bg-light">-->
<!--<span class="quote d-flex align-items-center justify-content-center">-->
<!--<i class="icon-quote-left"></i>-->
...
<!--         style="background-image:url(images/xbg_5.jpg.pagespeed.ic.Wq8X92pQs5.jpg)" data-stellar-background-ratio="0.5">-->
<!--    <div class="container">-->
...
<!--                    </div>-->
<!--                    <div class="img" style="background-image:url(images/xbg_1.jpg.pagespeed.ic.AOJSLrz8XS.jpg)"></div>-->
<!--                    <div class="px-4">-->
...
<!--                    </div>-->
<!--                    <div class="img" style="background-image:url(images/xbg_5.jpg.pagespeed.ic.Wq8X92pQs5.jpg)"></div>-->
<!--                    <div class="px-4">-->
<!--                        <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,-->
<!--                            there live the blind texts.</p>-->
<!--                    </div>-->
<!--                    <p class="button text-center"><a href="#" class="btn btn-quarternary px-4 py-3">Take A Course</a>-->
<!--                    </p>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
